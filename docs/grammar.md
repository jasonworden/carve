...
Implementations should match this grammar. The [case study](./casestudy_carve) explains the design rationale, the [reference page](./edge-cases) covers parsing edge cases, and the [examples](./examples) show the expected HTML output for each construct.
